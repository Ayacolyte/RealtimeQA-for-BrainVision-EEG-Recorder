            ...
            while ~isempty(tryheader)
                ...
                switch hdr.type
                    case 1       % Start, Setup information like EEG properties
                        ...
                        % initialising parameters for the QA algorithm
                        ...
                        % currentDir = pwd;
                        % subfolderPath = fullfile(currentDir, 'DRT_lib');
                        % if ~contains(path, [subfolderPath pathsep])
                    ...
                    case 4       % 32Bit Data block
                        ...
                        if dims(2) > 1000000 / props.samplingInterval
                            ...
                            data1s = data1s * 0.0488281;
                            [~,~,~,~,~,~,NS_track_new]=realtimeQA(data1s,props,fig1,HighPassband,seleChanns,badWindowThreshold,...
